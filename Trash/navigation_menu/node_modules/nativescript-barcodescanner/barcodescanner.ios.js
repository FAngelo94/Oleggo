    ...
    BarcodeScanner.prototype.scan = function (arg) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                ...
                self._scanDelegate = QRCodeReaderDelegateImpl.initWithOwner(new WeakRef(_this));
                self._scanner.delegate = self._scanDelegate;
                self._scanDelegate.setCallback(arg.beepOnScan !== false, isContinuous_1, arg.reportDuplicates, function (reader, text, format) {
                    if (text === undefined) {
                        self._removeVolumeObserver();
