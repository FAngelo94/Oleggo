...
parser.prototype.getTitles = function () {
    ...
    var req = https.getJSON("https://" + this.lng + titlesURL + encodeURIComponent(this.word) + "&srwhat=" + this.srwhat).then(function (result) {
            try { // par sécurité
            ...
            if (articles.length) {
                ...
                articles.forEach(function (article) {
                    ...
                    if (title != exclude && this.stripAccents(title.toLowerCase()) == word2)
        ...
        function (e) {
            //// Argument (e) is Error!
            this.sendErr(errors.req).bind(this);
        });
...
parser.prototype.getPage = function () {
    ...
    var req = https.getJSON("https://" + this.lng + pagesURL + encodeURIComponent(this.titles[0])).then(function (result) {
            try { // par sécurité
